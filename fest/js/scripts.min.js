...
$(function(){var e=$("#my-menu").mmenu({extension:["fullscreen","theme-white","fx-menu-slide","pagedim-black"],navbar:{title:"Меню"},offCanvas:{position:"left",pageNodetype:"#my-wrapper"}}),n=$("#my-icon"),i=e.data("mmenu");n.on("click",function(){i.open()}),i.bind("open:finish",function(){setTimeout(function(){n.addClass("is-active")},100)}),i.bind("close:finish",function(){setTimeout(function(){n.removeClass("is-active")},100)})});